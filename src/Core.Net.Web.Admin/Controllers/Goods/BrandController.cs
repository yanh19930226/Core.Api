...
namespace Core.Net.Web.Admin.Controllers.Goods
{
    ...
    public class BrandController : ControllerBase
    {
        ...
        public BrandController(/*IWebHostEnvironment webHostEnvironment,*/
            IBrandServices brandServices/*, ICoreCmsGoodsServices goodsServices*/)
        {
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<JsonResult> DoCreate([FromBody] Brand entity)
        {
            var jm = new AdminUiCallBack();
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<JsonResult> DoEdit([FromBody] Brand entity)
        {
            var jm = new AdminUiCallBack();
