...
namespace Core.Net.Web.Admin.Controllers.Goods
{
    ...
    public class CoreCmsGoodsCategoryController : Controller
    {
        ...
        public async Task<JsonResult> DoCreate([FromBody] CoreCmsGoodsCategory entity)
        {
            ...
            var result = await _coreCmsGoodsCategoryServices.InsertAddAsync(entity);
        ...
        public async Task<JsonResult> DoEdit([FromBody] CoreCmsGoodsCategory entity)
        {
            ...
            //事物处理过程结束
            var result = await _coreCmsGoodsCategoryServices.UpdateEditAsync(entity);
            var bl = result.code == 0;
            jm.code = bl ? 0 : 1;
        ...
        public async Task<JsonResult> DoDelete([FromBody] FMIntId entity)
        {
            ...
            var result = await _coreCmsGoodsCategoryServices.DeletedByIdAsync(entity.id);
            var bl = result.code == 0;
            jm.code = bl ? 0 : 1;
        ...
        public async Task<JsonResult> DoSetisShow([FromBody] FMUpdateBoolDataByIntId entity)
        {
            ...
            var result = await _coreCmsGoodsCategoryServices.UpdateEditAsync(oldModel);
            var bl = result.code == 0;
            jm.code = bl ? 0 : 1;
            jm.msg = bl ? GlobalConstVars.EditSuccess : GlobalConstVars.EditFailure;
